...
function _tasks_ordo(&$db,&$TWorkstation, $status, $fk_workstation=0) {
    ...
    $sql = "SELECT t.rowid,t.label,t.ref,t.fk_task_parent,t.fk_projet, t.grid_col,t.grid_row,";
    ...
    $sql.= "ex.fk_workstation,ex.needed_ressource
    ...
    while($obj = $db->fetch_object($res)) {
        ...
        $TTask[] = array(
                ...
                ,'fk_task_parent'=>empty($conf->global->SCRUM_GROUP_TASK_BY_RAL) ? 0 : (int)$obj->fk_task_parent
